...
import com.qzeng2490.permisson.common.ApplicationContextHelper;
...
import com.qzeng2490.permisson.service.SysCoreService;
...
@Slf4j
@WebFilter(urlPatterns = {"/admin/*","/sys/*"},initParams = {
        @WebInitParam(name = "exclusionUrls", value = "/sys/user/noAuth.page,/login.page")} )
public class MyAclControlFilter implements Filter {
